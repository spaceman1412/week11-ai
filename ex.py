...
def AC3(csp):
    ...
    # curr_domains: a copy of domains. We will do inference on curr_domains
            ...
            for b in csp.curr_domains[B][:]:
                if not csp.constraints(var, value, B, b):
                    ...
                    if removals is not None:
                        # variable B and value b are removed from its domain
                        removals.append((B, b))
    ...
    def backtrack(assignment):
        ...
        for value in order_domain_values(var, assignment, csp):
            if 0 == csp.nconflicts(var, value, assignment):
                ...
                removals = [(var, a)
                            for a in csp.curr_domains[var] if a != value]
...
if __name__ == '__main__':
    init_assign_easy = '..3.2.6..9..3.5..1..18.64....81.29..7.......8..67.82....26.95..8..2.3..9..5.1.3..' ' ENTER THE INITIAL ASSIGNMENT OF THE SUDOKU '''
    ...
    init_assign_hard = '..3.2.6..9..3.5..1..18.64....81.29..7.......8..67.82....26.95..8..2.3..9..5.1.3..'' ENTER THE INITIAL ASSIGNMENT OF THE SUDOKU '''
    sodoku = Sudoku(init_assign_hard)
    print('\nHARD SUDOKU:')
    sodoku.display()
    result = str(backtracking_search(sodoku))
